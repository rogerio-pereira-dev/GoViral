...
TEXT;
    ...
    expect($sections)
        ...
        ->and($sections['executive_summary'])
        ->toContain('Summary content.')
        ->and($sections['profile_score'])
        ->toContain('Score content.')
        ->and($sections['inferred_niche'])
        ->toContain('Niche content.')
        ->and($sections['username_suggestions'])
        ->toContain('Username content.')
        ->and($sections['optimized_bio'])
        ->toContain('Bio content.')
        ->and($sections['profile_optimization'])
        ->toContain('Optimization content.')
        ->and($sections['content_ideas'])
        ->toContain('Content ideas.')
        ->and($sections['viralization_tips'])
        ->toContain('Tips content.')
        ->and($sections['action_plan'])
